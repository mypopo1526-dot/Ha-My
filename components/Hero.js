            ...
            <div className="flex flex-col-reverse md:flex-row items-center gap-10 md:gap-16">
                ...
                >
                    <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96">
                        ...
                        <div className="relative w-full h-full rounded-2xl overflow-hidden shadow-2xl border-4 border-white rotate-3 hover:rotate-0 transition-transform duration-500 bg-gray-200 bg-cover bg-top" style={{ backgroundImage: "url('/hero-final.jpg?v=4')" }}>
                        </div>
                    </div>
