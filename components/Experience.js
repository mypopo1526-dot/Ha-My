...
export default function Experience() {
    return (
        <section className="w-full bg-slate-50 py-16 md:py-24 scroll-mt-20" id="experience">
            <div className="max-w-[1200px] mx-auto px-4 md:px-10">
                <div className="flex flex-col items-center mb-12 text-center">
                    <h2 className="text-3xl title-gradient mb-4">KINH NGHIỆM THỰC CHIẾN & AI</h2>
                    <p className="text-slate-600 max-w-2xl">Ứng dụng hệ sinh thái Google AI vào học tập, đời sống và các dự án thực tiễn.</p>
                </div>
                <motion.div
                    variants={container}
                    initial="hidden"
                ...
                >
                    <motion.div variants={item} className="group bg-white rounded-2xl p-6 shadow-sm hover:shadow-card transition-shadow border border-slate-100 flex flex-col h-full hover:-translate-y-2 duration-300">
                        <div className="h-48 rounded-xl bg-gradient-to-br from-blue-100 to-indigo-50 mb-6 flex items-center justify-center overflow-hidden relative">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-xl font-bold text-[#0d131c] mb-2 group-hover:text-google-blue transition-colors">Apply Google AI Daily</h3>
                            <p className="text-slate-600 text-sm leading-relaxed whitespace-pre-line">Thường xuyên áp dụng hệ sinh thái Google AI (Gemini, NotebookLM, Veo...) trong học tập, nghiên cứu và sáng tạo hằng ngày.
                    ...
                    <motion.div variants={item} className="group bg-white rounded-2xl p-6 shadow-sm hover:shadow-card transition-shadow border border-slate-100 flex flex-col h-full hover:-translate-y-2 duration-300">
                        <div className="h-48 rounded-xl bg-gradient-to-br from-purple-100 to-fuchsia-50 mb-6 flex items-center justify-center overflow-hidden relative">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-xl font-bold text-[#0d131c] mb-2 group-hover:text-purple-600 transition-colors">AI Workflow Design</h3>
                            <p className="text-slate-600 text-sm leading-relaxed whitespace-pre-line">Thiết kế và vận hành quy trình làm việc tích hợp AI bằng make2u và Gemini API.
                    ...
                    <motion.div variants={item} className="group bg-white rounded-2xl p-6 shadow-sm hover:shadow-card transition-shadow border border-slate-100 flex flex-col h-full lg:col-span-1 md:col-span-2 hover:-translate-y-2 duration-300">
                        <div className="h-48 rounded-xl bg-gradient-to-br from-red-100 to-orange-50 mb-6 flex items-center justify-center overflow-hidden relative">
                        ...
                        <div className="flex-1">
                            ...
                            <h3 className="text-xl font-bold text-[#0d131c] mb-2 group-hover:text-google-red transition-colors">AI for Business Growth</h3>
                            <p className="text-slate-600 text-sm leading-relaxed whitespace-pre-line">Triển khai Google AI vào dự án kinh doanh gia đình, tập trung vào tăng trưởng organic và tối ưu nội dung. Kết quả đo lường được:
